pro fbeye_delflare,f0,fevent,fstartpos,fstoppos,tpeak,tstart,tstop,trise,tdecay,lpeak,ed,cplx_flg,mltpk_flg,mltpk_num,tmltpk,lmltpk,multpos,filename=filename
...
; remove the event, and any sub-peaks w/ same fevent id
  ...
  fbeye_remove,rflare,tstart,tstop,trise,tdecay ; << NEW
