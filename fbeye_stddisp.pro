...
xyouts,.01,.85,'+ Sub-Peak',/normal;,color=50
xyouts,.1,.85,'- Sub-Peak',/normal;,color=50
...
xyouts,.01,.77,'Type ('+keynames[2]+')',/normal
...
xyouts,.16,.77,'!18i!3 ('+keynames[4]+')',/normal,charsize=1.4
...
;msg box
xyouts,/normal,.05,.42,'Msg:',charsize=1
