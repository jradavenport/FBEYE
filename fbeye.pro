...
printf,4,'# Event_ID, Start_INDX, Stop_INDX, t_peak, t_start, t_stop, t_rise, t_decay, Flux_peak, Equiv_Dur, CPLX_flg, MLTPK_flg, MLTPK_num, t_MLTPK, L_mltpk, MLTPK_INDX'
