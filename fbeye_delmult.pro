pro fbeye_delmult,f0,fevent,fstartpos,fstoppos,tpeak,tstart,tstop,trise,tdecay,lpeak,ed,cplx_flg,mltpk_flg,mltpk_num,tmltpk,lmltpk,multpos,s2n,quies,filename=filename
...
;  overmult = where(fevent eq fevent[overlap[0]] and $ ; same event ID
  ...
  fbeye_remove,overmult,s2n,quies
